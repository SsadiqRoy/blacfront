...
})({"2p0Me":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "33b2ca689cfdd9f2";
...
},{}],"kHBDz":[function(require,module,exports) {
var _problemsviewJs = require("../../view/admin/problemsview.js");
var _modelJs = require("../../model/model.js");
//
async function controlDelete(notificationId, btnId) {
    try {
        const res = await _modelJs.deletefull(`/problems/${notificationId}`);
        _problemsviewJs.renderDelete(res, btnId);
    } catch (error) {
        _problemsviewJs.displayError(error, btnId);
    }
}
async function init() {
    _problemsviewJs.initializer();
    _problemsviewJs.handleDelete(controlDelete);
}
init();

},{"../../view/admin/problemsview.js":"3mI0B","../../model/model.js":"cEBbY"}],"3mI0B":[function(require,module,exports) {
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["2p0Me","kHBDz"], "kHBDz", "parcelRequire517a")
