...
})({"7SjT7":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "acc5542ce850307b";
...
},{}],"2WimT":[function(require,module,exports) {
var _moviesviewJs = require("../../view/admin/moviesview.js");
var _modelJs = require("../../model/model.js");
//
async function controlDelete(cardId, btnId) {
    try {
        const res = await _modelJs.deletefull(`/movies/${cardId}`);
        _moviesviewJs.renderDelete(res, btnId);
    } catch (error) {
        _moviesviewJs.displayError(error, btnId);
    }
}
async function init() {
    _moviesviewJs.initializer();
    _moviesviewJs.handleDelete(controlDelete);
}
init();

},{"../../view/admin/moviesview.js":"dCfUe","../../model/model.js":"cEBbY"}],"dCfUe":[function(require,module,exports) {
...
function renderDelete(data, btn) {
    if (!data) {
    ...
    _utilsJs.alertResponse(`Movie - ${data.data.title} - has been deleted successfully`);
    _utilsJs.stopRotateBtn(btn);
    const id = data.data.id;
    const card = document.querySelector(`[data-card-id="${id}"`);
    card.parentElement.removeChild(card);
    _utilsJs.closePopup("delete-movie-popup");
}
...
async function handleTags() {
    ...
    body.addEventListener("click", (e)=>{
        ...
        _independentJs.searchItem("movie", target.textContent, "items-container", "dbMovieCard");
    });
}
function initializer() {
    _utilsJs.adminSidebar(), _utilsJs.adminSearchBar();
    managePopups();
    _independentJs.showMore("movie", "items-container", "dbMovieCard");
    _independentJs.searchItem("movie", "items-container", "dbMovieCard");
...
function managePopups() {
    ...
    container && container.addEventListener("click", (e)=>{
        ...
        if (target.classList.contains("delete-item")) {
            ...
            _utilsJs.openPopup("delete-movie-popup", ()=>{
                form.dataset.cardId = "";
            });
        }
    });
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["7SjT7","2WimT"], "2WimT", "parcelRequire517a")
