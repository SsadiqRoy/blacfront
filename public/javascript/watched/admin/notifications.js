...
})({"fZtIJ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "6defa107055ae28f";
...
},{}],"5eYo7":[function(require,module,exports) {
var _notificationsviewJs = require("../../view/admin/notificationsview.js");
var _modelJs = require("../../model/model.js");
//
async function controlDelete(notificationId, btnId) {
    try {
        console.log(notificationId);
        const res = await _modelJs.deletefull(`/notifications/${notificationId}`);
        _notificationsviewJs.renderDelete(res, btnId);
    } catch (error) {
        _notificationsviewJs.displayError(error, btnId);
    }
}
async function init() {
    _notificationsviewJs.initializer();
    _notificationsviewJs.handleDelete(controlDelete);
}
init();

},{"../../view/admin/notificationsview.js":"iR8ho","../../model/model.js":"cEBbY"}],"iR8ho":[function(require,module,exports) {
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["fZtIJ","5eYo7"], "5eYo7", "parcelRequire517a")
