...
})({"01HD9":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "e4e81083e416144f";
...
},{}],"a9wzQ":[function(require,module,exports) {
var _serieviewJs = require("../../view/client/serieview.js");
var _modelJs = require("../../model/model.js");
async function controlSuggestions({ In , notIn , text  }) {
    try {
        const response = await _modelJs.getfull(`/series?fields=title,portrait,rating,id&limit=12&text=${text}`);
        _serieviewJs.renderFillSuggestions({
            response,
            containerId: "suggestions",
            type: "serie",
            cardName: "movieCard"
        });
    } catch (error) {
...
async function initializer() {
    _serieviewJs.initializer();
    _serieviewJs.handleSuggestions(controlSuggestions);
}
initializer();

},{"../../view/client/serieview.js":"eaMxO","../../model/model.js":"cEBbY"}],"eaMxO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayError", ()=>displayError);
parcelHelpers.export(exports, "renderFillSuggestions", ()=>renderFillSuggestions);
/*
...
/*
  ...
  */ // =================== HANDLERS ==========
parcelHelpers.export(exports, "handleSuggestions", ()=>handleSuggestions);
/*
...
function renderFillSuggestions({ response , containerId , type , cardName  }) {
    ...
    if (data.length) {
        ...
        if (!meta.total) {
            ...
            const queryString1 = `?text=${text}`;
            button.href = `/${type}s${queryString1}`;
        }
    } else {
...
function handleSuggestions(controlSuggestions) {
...
function initializer() {
    ...
    _independentJs.suggest(), _independentJs.problem();
}
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["01HD9","a9wzQ"], "a9wzQ", "parcelRequire517a")
