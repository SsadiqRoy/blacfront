...
})({"3hKRd":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "e093e44cc614dfea";
...
},{}],"6rKj5":[function(require,module,exports) {
var _signupviewJs = require("../../view/client/signupview.js");
...
//
async function init() {
    _signupviewJs.handleSignup(controlSignup);
}
init();

},{"../../view/client/signupview.js":"lvler","../../model/model.js":"cEBbY"}],"lvler":[function(require,module,exports) {
...
function renderSignup(data) {
    if (data) {
        _utilsJs.alertResponse(`welcome to eventeos, ${data.name}`);
        _utilsJs.stopRotateBtn("signup-btn");
        // return;
        setTimeout(()=>{
...
function handleSignup(controlSignup) {
    const form = document.getElementById("signup");
    form.addEventListener("submit", (e)=>{
        e.preventDefault();
        _utilsJs.rotateBtn("signup-btn");
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["3hKRd","6rKj5"], "6rKj5", "parcelRequire517a")
