...
var _gamesviewJs = require("../../view/client/gamesview.js");
var _modelJs = require("../../model/model.js");
async function controlLoadContent(query) {
    try {
        const response = await _modelJs.getfull(`/games?fields=title,landscape,rating,id${query}`);
...
async function initializer() {
    _gamesviewJs.initializer();
    _gamesviewJs.handleLoadContent(controlLoadContent);
    _gamesviewJs.handleLoadMore(controlLoadMore);
}
initializer();

},{"../../view/client/gamesview.js":"kBh95","../../model/model.js":"cEBbY"}],"kBh95":[function(require,module,exports) {
...
function renderLoadContent({ response , containerId , type , cardName  }) {
    ...
    if (!data.length) redirector.innerHTML = `We couldn't find results for your search. Results in <a href="/series${query}">tv series</a> or in <a href="/movies${query}">movies</a>`;
    else redirector.innerHTML = `Find results in <a href="/series${query}">tv series</a> or in <a href="/movies${query}">movies</a>`;
}
