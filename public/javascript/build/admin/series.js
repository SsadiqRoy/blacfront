...
})({"9Mqw6":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "3198b5f82f8bdc0b";
...
},{}],"eKtnw":[function(require,module,exports) {
var _seriesviewJs = require("../../view/admin/seriesview.js");
var _modelJs = require("../../model/model.js");
//
async function controlDelete(cardId, btnId) {
    try {
        console.log(cardId);
        const res = await _modelJs.deletefull(`/series/${cardId}`);
        _seriesviewJs.renderDelete(res, btnId);
    } catch (error) {
        _seriesviewJs.displayError(error, btnId);
    }
}
async function init() {
    _seriesviewJs.initializer();
    _seriesviewJs.handleDelete(controlDelete);
}
init();

},{"../../view/admin/seriesview.js":"2vOic","../../model/model.js":"cEBbY"}],"2vOic":[function(require,module,exports) {
...
function renderDelete(data, btn) {
    ...
    _utilsJs.alertResponse(`Serie - ${data.data.title} - has been deleted successfully`);
    _utilsJs.stopRotateBtn(btn);
    const id = data.data.id;
    const card = document.querySelector(`[data-card-id="${id}"`);
    card.parentElement.removeChild(card);
    _utilsJs.closePopup("delete-serie-popup");
}
...
function initializer() {
    ...
    managePopups();
    _independentJs.showMore("serie", "items-container", "dbMovieCard");
    _independentJs.searchItem("serie", "items-container", "dbMovieCard");
}
/*
...
function managePopups() {
    ...
    container && container.addEventListener("click", (e)=>{
        ...
        if (target.classList.contains("delete-item")) {
            ...
            _utilsJs.openPopup("delete-serie-popup", ()=>{
                form.dataset.cardId = "";
            });
        }
    });
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["9Mqw6","eKtnw"], "eKtnw", "parcelRequire517a")
