...
})({"buHIF":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4c7bea76406e27e9";
...
},{}],"9o0c0":[function(require,module,exports) {
var _schedulesviewJs = require("../../view/admin/schedulesview.js");
var _modelJs = require("../../model/model.js");
//
async function controlDelete(scheduleId, btnId) {
    try {
        const res = await _modelJs.deletefull(`/schedules/${scheduleId}`);
        console.log(res);
        _schedulesviewJs.renderDelete(res, btnId);
    } catch (error) {
        _schedulesviewJs.displayError(error, btnId);
    }
}
async function init() {
    _schedulesviewJs.initializer();
    _schedulesviewJs.handleDelete(controlDelete);
}
init();

},{"../../view/admin/schedulesview.js":"8Ldgc","../../model/model.js":"cEBbY"}],"8Ldgc":[function(require,module,exports) {
...
function renderDelete(data, btn) {
    ...
    _utilsJs.alertResponse(`Schedule has been deleted successfully`);
    _utilsJs.stopRotateBtn(btn);
    const id = data.data.id;
    const card = document.querySelector(`[data-schedule-id="${id}"`);
    card.parentElement.removeChild(card);
    _utilsJs.closePopup("delete-schedule-popup");
}
...
function managePopups() {
    ...
    container && container.addEventListener("click", (e)=>{
        ...
        if (target.classList.contains("delete-item")) {
            ...
            _utilsJs.openPopup("delete-schedule-popup", ()=>{
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["buHIF","9o0c0"], "9o0c0", "parcelRequire517a")
