...
})({"5RKFX":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "68a735cfa5736c55";
...
},{}],"gE8yZ":[function(require,module,exports) {
var _seasonformviewJs = require("../../view/admin/seasonformview.js");
...
async function controlUpdate(seasonId, btnId) {
    try {
        const data = _seasonformviewJs.getSeasonData();
        const season = await _modelJs.patch(`/seasons/${seasonId}`, data);
        _seasonformviewJs.renderCreate(season, "updated", btnId);
    } catch (error) {
        _seasonformviewJs.displayError(error, btnId);
    }
}
...
},{"../../view/admin/seasonformview.js":"Wos1a","../../model/model.js":"cEBbY"}],"Wos1a":[function(require,module,exports) {
...
//
parcelHelpers.export(exports, "renderCreateEpisode", ()=>renderCreateEpisode);
/**
...
function renderCreate(data, action, btnId) {
    if (!data) {
        _utilsJs.stopRotateBtn(btnId);
        return _utilsJs.alertResponse("failed creating/updating or could not display results - try find on parent Tv Serie page", 6, "failed");
    }
    _utilsJs.alertResponse(`Season - ${data.title || ""} - has been ${action}`);
    _utilsJs.stopRotateBtn(btnId);
    window.setTimeout(()=>{
        window.location.assign(`/dashboard/updateserie/${data.serie}`);
    }, 3500);
}
function renderCreateEpisode(data, action, btnId) {
    if (!data) {
        _utilsJs.stopRotateBtn(btnId);
...
function handleCreateEpisode(controlCreateEpisode, controlUpdateEpisode) {
...
function handleDeleteEpisode(controlDeleteEpisode) {
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["5RKFX","gE8yZ"], "gE8yZ", "parcelRequire517a")
