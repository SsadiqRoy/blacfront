...
})({"bqkVE":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "e73bba200949d9bf";
...
},{}],"fldAO":[function(require,module,exports) {
var _serieformviewJs = require("../../view/admin/serieformview.js");
var _modelJs = require("../../model/model.js");
// ================== CONTROLLERS CALLED IN VIEW ==
async function controlCreate(btnId) {
    try {
        const serieData = _serieformviewJs.getSerieData();
        const serie = await _modelJs.post("/series/create", serieData);
        // const { id } = serie;
        // await saveLinks(id);
        _serieformviewJs.renderCreated(serie, "created", btnId);
    } catch (error) {
        _serieformviewJs.displayError(error, btnId);
    }
}
//
async function controlUpdate(serieId, btnId) {
    try {
        const serieData = _serieformviewJs.getSerieData();
        const serie = await _modelJs.patch(`/series/${serieId}`, serieData);
        // await updateLinks();
        _serieformviewJs.renderCreated(serie, "updated", btnId);
    } catch (error) {
        _serieformviewJs.displayError(error, btnId);
    }
}
...
async function controlDeleteSeason(seasonId, btnId) {
    try {
        const res = await _modelJs.deletefull(`/seasons/${seasonId}`);
        _serieformviewJs.renderDeleteSeason(res, btnId);
    } catch (error) {
        _serieformviewJs.displayError(error, btnId);
    }
}
...
*/ // =================== NINITIALIZER ===============
async function init() {
    _serieformviewJs.initializer();
    _serieformviewJs.handleCreate(controlCreate, controlUpdate);
    _serieformviewJs.handleDeleteSeason(controlDeleteSeason);
}
init(); /*
...
},{"../../view/admin/serieformview.js":"e1OWl","../../model/model.js":"cEBbY"}],"e1OWl":[function(require,module,exports) {
...
//
//
parcelHelpers.export(exports, "renderDeleteSeason", ()=>renderDeleteSeason);
/*
...
*/ // ================== GETTERS =================
parcelHelpers.export(exports, "getSerieData", ()=>getSerieData);
/*
...
//
parcelHelpers.export(exports, "handleDeleteSeason", ()=>handleDeleteSeason);
/*
...
function renderCreated(data, action, btnId) {
    if (!data) {
        ...
        return _utilsJs.alertResponse("failed creating/updating or could not display results - try find on series page", 6, "failed");
    }
...
function renderDeleteSeason(data, btnId) {
    ...
    _utilsJs.alertResponse(`Season has been deleted`);
    _utilsJs.stopRotateBtn(btnId);
    window.setTimeout(()=>{
...
function initializer() {
    _utilsJs.fillSelects("serie-country", "countries");
    _utilsJs.fillSelects("serie-status", "serieStatus");
    manageSeasonPopup();
}
/*
...
function manageSeasonPopup() {
    ...
    cover && cover.addEventListener("click", (e)=>{
        ...
        if (target.classList.contains("delete-item")) {
            ...
            _utilsJs.openPopup("delete-season-popup", ()=>{
...
},{"./../utils.js":"lbtnr","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["bqkVE","fldAO"], "fldAO", "parcelRequire517a")
